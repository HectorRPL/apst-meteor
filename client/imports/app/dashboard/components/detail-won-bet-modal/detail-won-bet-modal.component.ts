...
@Component({
    selector: 'app-detail-won-bet-modal',
    templateUrl: './detail-won-bet-modal.component.html',
    styleUrls: ['./detail-won-bet-modal.component.scss']
})
export class DetailWonBetModalComponent implements OnInit {
