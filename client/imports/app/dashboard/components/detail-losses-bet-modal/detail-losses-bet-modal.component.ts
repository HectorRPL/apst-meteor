...
@Component({
    selector: 'app-detail-losses-bet-modal',
    templateUrl: './detail-losses-bet-modal.component.html',
    styleUrls: ['./detail-losses-bet-modal.component.scss']
})
export class DetailLossesBetModalComponent implements OnInit {
