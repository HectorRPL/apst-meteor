...
@Component({
    selector: 'app-detail-draw-bet-modal',
    templateUrl: './detail-draw-bet-modal.component.html',
    styleUrls: ['./detail-draw-bet-modal.component.scss']
})
export class DetailDrawBetModalComponent implements OnInit {
