...
@Component({
  selector: 'app-detail-active-bet-modal',
  templateUrl: './detail-active-bet-modal.component.html',
  styleUrls: ['./detail-active-bet-modal.component.scss']
})
export class DetailActiveBetModalComponent implements OnInit {
